            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="/admin/beranda">
                        ...
                        <span class="nav-link-text ms-1 {{ $page == 'beranda' ? 'active' : '' }}">Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $page == 'dokumen' ? 'active' : '' }}" href="/admin/dokumen">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="/admin/user">
                        ...
                        <span class="nav-link-text ms-1 {{ $page == 'user' ? 'active' : '' }}">User</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="/admin/pengajuan">
                        ...
                        <span class="nav-link-text ms-1 {{ $page == 'pengajuan' ? 'active' : '' }}">Pengajuan {{ (PermohonanDetail::getBelumProses()!=0)?'<span class="badge bg-primary">'. PermohonanDetail::getBelumProses().' </span> ':''}}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="/admin/cetak_laporan">
                        ...
                        <span class="nav-link-text ms-1 {{ $page == 'cetak' ? 'active' : '' }}">Cetak Laporan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="/admin/profil">
                        ...
                        <span class="nav-link-text ms-1 {{ $page == 'profil' ? 'active' : '' }}">Admin</span>
                    </a>
                </li>
                <li class="nav-item">
