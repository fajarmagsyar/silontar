...
<head>
    <meta charset="utf-8">
    <title>SiLONTAR - Masukkan password baru</title>
            ...
            <div class="row g-0 justify-content-start">
                <div class="col-lg-5 mx-auto">
                    <div class="bg-white text-center p-5" style="border-radius: 20px">
                        ...
                        <form action="/auth/reset-pass/store/{{ $token }}" method="post">
                            @csrf
                            <div class="row g-3">
                                @if (session()->has('error'))
                                ...
                                <div class="col-6 ml-auto">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Reset
                                        Password</button>
                                </div>
                            </div>
                        </form>
